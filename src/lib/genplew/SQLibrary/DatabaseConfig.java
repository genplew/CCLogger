...
public class DatabaseConfig {
	...
	public enum Parameter {
		HOSTNAME(DatabaseType.MYSQL), USER(DatabaseType.MYSQL), PASSWORD(DatabaseType.MYSQL),
		PORT_NUMBER(DatabaseType.MYSQL), DATABASE(DatabaseType.MYSQL), DB_PREFIX(DatabaseType.ALL),
		DB_LOCATION(DatabaseType.SQLITE), DB_NAME(DatabaseType.SQLITE);
	...
	public DatabaseConfig setParameter(Parameter param, String value)
		...
		if (!param.validParam(type))
			throw new InvalidConfiguration(
					param.toString() + " is invalid for a database type of : " + type.toString());
